 ...
 */
package net.hoatle.dps.gof.abstractfactory.widget.osx;

import net.hoatle.dps.gof.abstractfactory.widget.Window;

/**
 * The {@link net.hoatle.dps.gof.abstractfactory.widget.Window} implementation on OSX environment.
 *
 * @author <a href="http://hoatle.net">hoatle (hoatlevan at gmail dot com)</a>
 * @since Jun 5, 2011
 */
public final class OSXWindow implements Window {
